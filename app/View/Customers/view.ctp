	...
	<?php foreach ($customer['Investment'] as $investment): ?>
		<tr>
			...
			<td class="actions">
				...
				<?php echo $this->Form->postLink(__('Delete'), array('controller' => 'investments', 'action' => 'delete', $investment['id']), array('confirm' => __('Are you sure you want to delete # %s?', $investment['id']))); ?>
			</td>
		</tr>
	<?php endforeach; ?>
	</table>
